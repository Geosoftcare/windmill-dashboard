    ...
    <div class="container">
      ...
      <div class="row justify-content-center text-center">
        <div class="col-md-7 mb-5">
          ...
          <p>We can assist you whether you're just starting out with digital marketing or you're already successful and want to expand more quickly. Examine every feature together.</p>
        </div>
      </div>
      <div class="row align-items-stretch">
        ...
        <div class="col-lg-4 mb-4 mb-lg-0">
          <div class="pricing h-100 text-center popular">
            ...
            <div class="price-cta">
              <strong class="price">£0.00/month</strong>
              <p><a href="#" class="btn btn-white">Choose Plan</a></p>
            </div>
          </div>
        </div>
