...
<body>
    ...
    <div style="width: 100%; height:350px; text-align:center; background-image: url('../assets/img/23-bgs.jpg'); padding:22px; color:white; background-size: cover;">
        ...
        <div style="width: 100%; height:auto; padding:22px; margin-top:80px; color:rgba(236, 240, 241,.9);">
            <h1><strong>Reset passcode</strong></h1>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <h6 style="font-weight:600; margin-top:3%; width: 100%; height:auto; padding:5px; text-align:center; color:rgba(44, 62, 80,.6); font-size:20px;">Reset passcode</h6>
                <div style="width: 100%; height:auto; margin-top:-16px;">
                    <form action="./reset-pin" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="pin-login" id="mainPinLogin">
                            <input inputmode="numeric" placeholder="&#x2022;&#x2022;&#x2022;&#x2022;&#x2022;" pattern="[0-9]*" type="password" class="form-control" minlength="5" style="height: 55px; font-size:22px; text-align:center; background-color:rgba(127, 140, 141,.5);" name="txtPassword" />
                            <br>
    ...
    border:none; font-size:32px;" name="btnResetPinCode" type="submit"><i class="bi bi-box-arrow-in-right"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
