...
<body>
    ...
    <div style="width: 100%; height:350px; text-align:center; background-image: url('../assets/img/23-bgs.jpg'); padding:22px; color:white; background-size: 100% 100%;">
        ...
        <div style="width: 100%; height:auto; padding:22px; margin-top:80px; color:rgba(236, 240, 241,.9);">
            ...
            <h2><strong>Create Passcode</strong></h2>
        </div>
    </div>
    ...
    <div style="margin-top:-60px;" class="container">
        <div class="row">
            <form action="./create-pin" method="post" autocomplete="off" enctype="multipart/form-data">
                <div style="text-align:center; padding:22px; width:100%; height:auto;">
                    <h4><strong>Enter new passcode</strong></h4>
                    <input id="tbInput" placeholder="&#x2022;&#x2022;&#x2022;&#x2022;" label="Minimum 4 digits" type="password" class="form-control" minlength="4" maxlength="4" name="txtPassword" />
                    ...
                    while ($rows = mysqli_fetch_array($selectmyQuery)) { ?>
                        ...
                        <div id="VirtualKey">
                            <div class="row">
                                ...
                                <div class="col-sm-4 col-4">
                                    <div id="txtInputBox">
                                        <button type="submit" name="btnSubmitPinCode" id="btnlog"><i class="bi bi-box-arrow-in-right"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
