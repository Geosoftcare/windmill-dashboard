...
<body>
    <div style="width: 100%; height:350px; text-align:center; background-image: url('../assets/img/23-bgs.jpg'); padding:22px; color:white; background-size: 100% 100%;">
        ...
        <a href="./forgot-pin" style="text-decoration: none; color:white; font-size:20px; padding:22px;">
            <span style="float: right;"><strong>Forgot?</strong></span>
        </a>
    ...
    <div style="margin-top:-60px;" class="container">
        <div class="row">
            <form action="./processing-user-signin" method="post" autocomplete="off" enctype="multipart/form-data">
                <div style="text-align:center; padding:22px; width:100%; height:auto;">
                    <h4><strong>Enter Passcode</strong></h4>
                    <input id="tbInput" placeholder="&#x2022;&#x2022;&#x2022;&#x2022;" label="Minimum 4 digits numbers" pattern="[0-9]*" type="password" class="form-control" minlength="4" maxlength="4" name="txtPassword" />
                    ...
                    <div id="VirtualKey">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-4">
                                <div id="txtInputBox">
                                    <button type="submit" name="btncarerLogin" id="btnlog"><i class="bi bi-box-arrow-in-right"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!--<div style="width: 100%; height:auto; padding:22px; font-size:18px; color:black; margin-top:30px;">
                            <hr>
