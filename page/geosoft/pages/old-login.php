        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div style="width: 100%; height:auto; margin-top:-15px; background-color:#fff; z-index:1000;">
                    <form action="./old-login" method="post" autocomplete="off" enctype="multipart/form-data">
                        <div class="pin-login" id="mainPinLogin">
                            <input placeholder="&#x2022;&#x2022;&#x2022;&#x2022;" label="Passcode must be in 4 digits numbers" inputmode="numeric" pattern="[0-9]*" type="password" class="form-control" maxlength="4" minlength="4" style="height: 55px; font-size:28px; text-align:center; background-color:rgba(127, 140, 141,.3); color:black;" name="txtPassword" />
                            <br>
