...
<head>
    ...
    <?php include('processing-reset-pin.php'); ?>
...
<body>
    ...
    <div style="width: 100%; height:350px; text-align:center; background-image: url('../assets/img/23-bgs.jpg'); padding:22px; color:white; background-size: 100% 100%;">
        ...
        <a href="./index" style="text-decoration: none; color:white; font-size:20px; padding:22px;">
            <span style="float: right;"><strong>Login</strong></span>
        </a>
        <div style="width: 100%; height:auto; padding:22px; margin-top:60px; color:rgba(236, 240, 241,.9);">
            <h2><strong>Reset Passcode</strong></h2>
        </div>
    </div>

    <div style="margin-top:-60px;" class="container">
        <div class="row">
            <form action="./reset-pin" method="post" autocomplete="off" enctype="multipart/form-data">
                <div style="text-align:center; padding:22px; width:100%; height:auto;">
                    ...
                    <input type="hidden" value="<?php echo "" . $_SESSION['usr_email'] . ""; ?>" name="txtClientSessionEm" />

                    <div class="pin-login" id="mainPinLogin">
                        <input id="tbInput" placeholder="&#x2022;&#x2022;&#x2022;&#x2022;" label="Minimum 4 digits" pattern="[0-9]*" type="password" class="form-control" minlength="4" maxlength="4" name="txtPassword" />
                    </div>
                    ...
                    <div id="VirtualKey">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-4">
                                <div id="txtInputBox">
                                    <button type="submit" name="btnResetPinCode" id="btnlog"><i class="bi bi-box-arrow-in-right"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
