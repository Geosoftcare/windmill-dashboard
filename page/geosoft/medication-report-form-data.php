                ...
                <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    if (isset($_GET['col_taskId'])) {
                        ...
                        while ($get_client_meds_row = mysqli_fetch_array($sel_client_meds_result)) { ?>
                            ...
                            <div style="width:100%; height:auto; padding:2px; margin-top:-15px; color:rgba(44, 62, 80,.8);" class="my-6 font-semibold text-gray-700 dark:text-gray-200">
                                <?php echo "" . $get_client_meds_row['med_details'] . "" ?></div>
                            ...
                            <div style="margin-top: -20px;" class="flex mb-0 font-semibold text-gray-600 dark:text-gray-300 items-center p-1 bg-white dark:bg-gray-800">
                                <div style='width:100%; height:auto;display:block;'>
                                    ...
                                    <form action="./processing-med-submision?col_taskId=<?php echo $col_taskId ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
                                        ...
                                        <?php
                                        $sel_carers_result = mysqli_query($conn, "SELECT * FROM tbl_goesoft_carers_account WHERE (user_email_address='" . $_SESSION['usr_email'] . "' AND col_company_Id='" . $_SESSION['usr_compId'] . "') ");
                                        while ($get_carers_data_row = mysqli_fetch_array($sel_carers_result)) { ?>
                                            ...
                                            while ($careCall_row = mysqli_fetch_array($get_care_callId)) { ?>
                                                ...
                                                <br>
                                                <div id="popupNoOptions" style="width: 100%; height:auto;">
                                                    <textarea style="margin-top: -12px;" name="txtTaskNoteNoOp" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-900 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" rows="5" placeholder="Note"></textarea>
                                                </div>
                                                <br>
                                                ...
                                                <div id="popupYesOptions" style="width: 100%; height:auto;">
                                                    <br>
                                                    <label style="font-size: 16px; color:rgba(44, 62, 80,.7);" for="for note">E.g Prompt, observed, not observed...</label>
                                                    <br>
                                                    <br>
                                                    <textarea style="margin-top: -12px;" name="txtTaskNoteYesOp" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-900 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" rows="5" placeholder="Note"></textarea>
                                                </div>
                                                <br>
