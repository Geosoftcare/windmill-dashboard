...
<body>
  ...
  <form action="./email-login" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              <div id="popupAlert2" style="width: 100%; height:auto; margin-bottom:5px; padding:15px; background-color:#d35400; color:white;">
                Account not verified!!!
              </div>

              <label class="block">
                <span class="text-gray-700 dark:text-gray-400">Email</span>
                <input id="txtUserLog" required name="txtCarerEmail" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="example@gmail.com" />
              </label>

              <label class="block mt-4">
                <span class="text-gray-700 dark:text-gray-400">Password</span>
                <input id="txtUserLog" required name="txtCarerPassword" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="***************" type="password" />
              </label>

              <!-- You should use a button here, as the anchor is only used for the example  -->
              <button id="txtUserLog" type="submit" name="btncarerLogin" class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="../index.html">
                Log in
              </button>
