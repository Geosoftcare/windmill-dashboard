...
if (isset($_GET['uryyToeSS4'])) {
    ...
    if ($echomyTime > 06 and $echomyTime < 11) {
        ...
        if ($echoCurDay == 'Monday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call1='Breakfast' AND monday='$echoCurDay' ")); {
            ...
            if ($result_finiTask0) {
                if ($result_finiTask = mysqli_query($conn, "SELECT * FROM tbl_finished_tasks WHERE category='Medication' AND task_date='$currentDate' ")); {
        ...
        if ($echoCurDay == 'Tuesday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call1='Breakfast' AND tuesday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Wednesday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call1='Breakfast' AND wednesday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Thursday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call1='Breakfast' AND thursday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Friday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call1='Breakfast' AND friday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Saturday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call1='Breakfast' AND saturday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Sunday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call1='Breakfast' AND sunday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
    ...
    if ($echomyTime > 11 and $echomyTime < 14) {
        ...
        if ($echoCurDay == 'Monday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call2='Lunch' AND monday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Tuesday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call2='Lunch' AND tuesday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Wednesday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call2='Lunch' AND wednesday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Thursday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call2='Lunch' AND thursday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Friday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call2='Lunch' AND friday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Saturday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call2='Lunch' AND saturday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Sunday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call2='Lunch' AND sunday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
    ...
    if ($echomyTime > 14 and $echomyTime < 18) {
        ...
        if ($echoCurDay == 'Monday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call3='Tea' AND monday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Tuesday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call3='Tea' AND tuesday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Wednesday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call3='Tea' AND wednesday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Thursday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call3='Tea' AND thursday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Friday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call3='Tea' AND friday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Saturday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call3='Tea' AND saturday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Sunday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call3='Tea' AND sunday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
    ...
    if ($echomyTime > 18 and $echomyTime < 23) {
        ...
        if ($echoCurDay == 'Monday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call4='Bed' AND monday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Tuesday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call4='Bed' AND tuesday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Wednesday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call4='Bed' AND wednesday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Thursday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call4='Bed' AND thursday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Friday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call4='Bed' AND friday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Saturday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call4='Bed' AND saturday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
        ...
        if ($echoCurDay == 'Sunday') {
            if ($result = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE uryyToeSS4='$uryyToeSS4' AND care_call4='Bed' AND sunday='$echoCurDay' ")); {
                $rowcount_clientTask_records = mysqli_num_rows($result);
            }
