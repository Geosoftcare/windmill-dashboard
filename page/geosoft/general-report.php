            ...
            <div style="margin-top: 20px;" class="grid gap-6 mb-8 md:grid-cols-2">
                <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <div style="margin-top:20xp; width:100%; height:auto; padding:6px 0px 6px 18px; border-left:10px rgba(16, 172, 132,1.0) solid;" class="my-6 font-semibold text-gray-700 dark:text-gray-200">
                        Drop a general report on what you have done and observerd today. You can also report any issue if neccessary.
                    </div>
                        ...
                        <div style='width:100%; height:auto;display:block;'>
                            ...
                            while ($careCall_row = mysqli_fetch_array($get_care_callId)) {
                                ...
                                <form action="./processing-general-report?uryyToeSS4=<?php echo "" . $careCall_row['uryyToeSS4'] . ""; ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <input type="hidden" value="<?php echo "" . $row_get_carerId['col_mileage'] . ""; ?>" name="txtCarerMileage" />
