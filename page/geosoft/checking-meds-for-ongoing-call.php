...
$sel_carer_data_result = mysqli_query($conn, "SELECT * FROM tbl_care_calls WHERE (col_shift_date = '$today' 
...
if ($txtVariousCareCalls == 'Morning' or $txtVariousCareCalls == 'Breakfast') {
    ...
    if ($echoCurDay == 'Monday') {
        ...
        if ($rowcount_clientTask_records == $rowcount_finclientTask) {
            header("Location: ./general-report-for-ongoing-call?uryyToeSS4=$uryyToeSS4");
        } else {
