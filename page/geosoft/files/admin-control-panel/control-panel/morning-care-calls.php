...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        <div class="row">
            ...
            <div class=" col-xl-8">
                <h5>Update care call <br> <small><?php print $client_name; ?> Morning visit time</small></h5>
                <hr>
                ...
                <form method="POST" action="./processing-morning-care-call" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        $tomorrowDate = $datetime->format('d-m-Y');
                    ?>
