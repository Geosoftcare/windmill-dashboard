                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <form method="POST" action="./add-new-client" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="txtClientailment" required type="text" class="form-control" id="exampleInputClientailment" placeholder="Describe client condition!">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="txtclientArea" required class="form-control" id="exampleFormControlSelect1">
                                                    <option value='' selected='selected' disabled='disabled'>--Select Option--</option>
                                                    <?php
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="txtCareServices" required class="form-control" id="exampleFormControlSelect1">
                                                            <option value="" selected="selected" disabled="disabled">--Select Option--</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-4 col-6">
                                                    ...
                                                    <input name="txtPosterCode" required type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Postal Code">
                                                </div>
                                                <div class="col-md-8 col-6">
                                        ...
                                        <div style="border-left: 5px solid rgba(192, 57, 43,1.0); background-color:rgba(189, 195, 199,.2); width:100%; height:auto; padding:22px;">
                                            ...
                                            <select name="txtOfficeIncharge" required type="text" class="form-control" id="exampleFormControlSelect1" placeholder="City">
                                                <optgroup label="England">England
                                                    <option value="Bath">Bath</option>
                                                    <option value="Birmingham">Birmingham</option>
                                                    <option value="Bradford">Bradford</option>
