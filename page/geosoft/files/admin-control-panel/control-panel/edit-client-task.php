...
<?php
$result = mysqli_query($conn, "SELECT client_taskName,client_Id,col_period_one,col_period_two,uryyToeSS4, SUBSTRING(monday, 1, 1) AS MDay, SUBSTRING(tuesday, 1, 1) AS TDay, SUBSTRING(wednesday, 1, 1) AS WDay, SUBSTRING(thursday, 1, 1) AS THDay, SUBSTRING(friday, 1, 1) AS FDay, SUBSTRING(saturday, 1, 1) AS SDay, SUBSTRING(sunday, 1, 1) AS SATDay, 
...
FROM tbl_clients_task_records WHERE (client_Id=$_GET[client_Id] AND col_company_Id = '" . $_SESSION['usr_compId'] . "') ORDER BY client_Id ASC");
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Edit client task</h5>
                                <hr>
                                <h5 style="font-size:20px;"><?php echo "" . $row['client_taskName'] . " |
                            ...
                            <div class="table-responsive">
                                <div class="client-form-body" style="width:100%; height:auto; padding:22px;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <form method="POST" action="./processing-edit-client-task?client_Id=<?php echo "" . $row['client_Id'] . ""; ?>" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
                                                <div class="form-group">
                                                    <input type="hidden" name="txtTaskId" value="<?php echo "" . $row['client_Id'] . ""; ?>" />
                                                ...
                                                <button style='height:50px;' type="submit" name="btnEditClientTask" class="btn btn-primary">Edit task</button>
                                        ...
                                        <div class="col-md-7">
                                            <?php include_once('edit-client-task-table.php'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
