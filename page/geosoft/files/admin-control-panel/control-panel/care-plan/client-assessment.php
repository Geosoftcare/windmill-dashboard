                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h4 class="m-b-10"><?php echo "" . $row['assessment_name'] . ""; ?></h4>
                            </div>
                            <ul class="breadcrumb">
                                <li style="font-size: 16px;" class="breadcrumb-item">
                                    Capture outcomes, tasks and risks related to's <?php echo "" . $row['assessment_name'] . ""; ?> plan.
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container my-5">
                <div class="row text-decoration-none mt-3 rounded">
                    <div class="col-md-6 col-sm-6 col-xl-6 col-lg-6">
                        ...
                        Record <?php echo "" . $row['client_name'] . ""; ?>'s level of independence for each <?php echo "" . $row['assessment_name'] . ""; ?> activity, and any support that is required
                        <a href="./start-review-assessment?assessment_Id=<?php echo "" . $row['assessment_Id'] . ""; ?>" style="width: 200px;"
