                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h4 class="m-b-10">Equipment risk assessment</h4>
                                </div>
                                <ul class="breadcrumb">
                                    <li style="font-size: 16px;" class="breadcrumb-item">
                                        Capture outcomes, tasks and risks related to <?php echo "" . $row['client_first_name'] . "" ?>'s Equipment risk assessment.
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            <h5>1. Equipment risk assessment</h5>
                            <span style="font-size: 16px;">
                                Record <?php echo "" . $row['client_first_name'] . "" ?>'s level of independence for each Equipment risk assessment activity, and any support that is required.
                            </span>


                            <br><br>
                            <a href="./review-equipment-risk-assessment?<?php echo "uryyToeSS4=" . $row['uryyToeSS4'] . "";
                                                                    }
                            ...
                            if (isset($_GET['uryyToeSS4'])) {
                                $uryyToeSS4 = $_GET['uryyToeSS4'];
                                $result = mysqli_query($conn, "SELECT * FROM tbl_equipment_risk_assessment WHERE uryyToeSS4='$uryyToeSS4' ");
                                while ($row = mysqli_fetch_array($result)) { ?>
