...
if (isset($_POST['btnSubmitOutcomeassessment'])) {
    ...
    $txtColumn_4 = mysqli_real_escape_string($conn, $_REQUEST['txtComment']);
    ...
    $txtclientTasks = "Null";
    $txtAssessmentType = "Assessment3";
    $txtClientId = mysqli_real_escape_string($conn, $_REQUEST['txtClientId']);


    $queryIns = mysqli_query($conn, "INSERT INTO tbl_outcome_of_assessment (my_description, col_yes, col_no, comments, submitedDate, assessorName, assessorEmail, help_tasks, assessment_type, uryyToeSS4) 
    VALUES('" . $txtColumn_1 . "', '" . $txtColumn_2 . "', '" . $txtColumn_3 . "', '" . $txtColumn_4 . "', '" . $txtCurrentDate . "', '" . $txtAssessorName . "', '" . $txtAssessorEmail . "', '" . $txtclientTasks . "', '" . $txtAssessmentType . "', '" . $txtClientId . "') ");
    if ($queryIns) {
        header("Location: ./assessment-page-3?uryyToeSS4=$txtClientId");
                ...
                <div class="col-xl-12 col-md-12">
                    ...
                    if (isset($_GET['uryyToeSS4'])) {
                        ...
                        while ($trans = mysqli_fetch_array($result)) { ?>
                            ...
                            <h3>Assessment comment</h3>

                            <form action="./assessment-page-3<?php echo "?uryyToeSS4=" . $trans['uryyToeSS4'] . "" ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class='row'>
                                    ...
                                    <div class='col-xl-1 col-2'>
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type="checkbox" name="txtNotCapable" value="Yes" />
                                        </div>
                                    </div>
                                    <div class='col-xl-1 col-2'>
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input type="checkbox" name="txtUnabletoAssist" value="No" />
                                        </div>
                                    </div>
                                    <div class='col-xl-5 col-5'>
                                        <div class="form-group">
                                            <label for="Description">Comment</label>
                                            <textarea name="txtComment" id="" rows="4" class="form-control" required placeholder="Comment"></textarea>
                                        </div>
                                    </div>
