...
if (isset($_POST['btnAddNotes'])) {
    ...
    $sqlUpdateTable = mysqli_query($conn, "UPDATE `tbl_general_client_form` SET `my_mental_health` = '$txtMyNote' WHERE uryyToeSS4 = '$txtClientId' ");
                    ...
                    <div class="card-body" style="font-size: 16px;">
                        ...
                        if (isset($_GET['uryyToeSS4'])) {
                            ...
                            while ($row = mysqli_fetch_array($result)) { ?>
                                ...
                                <form action="./my-mental-health<?php echo "?uryyToeSS4=" . $row['uryyToeSS4'] . " "; ?>" method="POST" enctype="multipart/form-data" name="deactivate-admin" autocomplete="off">
