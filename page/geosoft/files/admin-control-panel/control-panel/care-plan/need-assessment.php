                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h4 class="m-b-10">Need assessment</h4>
                        </div>
                        <ul class="breadcrumb">
                            <li style="font-size: 16px;" class="breadcrumb-item">
                                Capture outcomes, tasks and risks related to <?php echo $varFirstName ?>'s need assessment.
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-md-6">
                    ...
                    <span style="font-size: 16px;">
                        Record <?php echo $varFirstName ?>'s level of independence for each needs assessment activity, and any support that is required.
                    </span>


                    <br><br>
                    <a href="./review-needs-assessment?<?php echo "uryyToeSS4=" . $uryyToeSS4; ?>" style="text-decoration: none;">
                    ...
                    <br>
                    <?php
                    $query = "SELECT * FROM tbl_needs_assessment WHERE uryyToeSS4 = ?";
            ...
            <div class="row">
                <div class="col-xl-6 col-md-6">
                    ...
                    $stmt = $conn->prepare("SELECT * FROM tbl_clients_task_records WHERE uryyToeSS4 = ?");
                    $stmt->bind_param("s", $uryyToeSS4);
                    $stmt->execute();
                    $result = $stmt->get_result();
                    while ($row = $result->fetch_assoc()) {
                        echo "<h5>-- " . $row['client_taskName'] . "</h5>";
                    } ?>
