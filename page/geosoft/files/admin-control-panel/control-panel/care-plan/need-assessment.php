                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    <li style="font-size: 16px;" class="breadcrumb-item">
                                        Capture outcomes, tasks and risks related to <?php echo "" . $row['client_first_name'] . "" ?>'s need assessment.
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            ...
                            <span style="font-size: 16px;">
                                Record <?php echo "" . $row['client_first_name'] . "" ?>'s level of independence for each needs assessment activity, and any support that is required.
                            </span>


                            <br><br>
                            <a href="./review-needs-assessment?<?php echo "uryyToeSS4=" . $row['uryyToeSS4'] . "";
                                                            }
                            ...
                            if (isset($_GET['uryyToeSS4'])) {
                                $uryyToeSS4 = $_GET['uryyToeSS4'];
                                $result = mysqli_query($conn, "SELECT * FROM tbl_needs_assessment WHERE uryyToeSS4='$uryyToeSS4' ");
                                while ($row = mysqli_fetch_array($result)) { ?>
