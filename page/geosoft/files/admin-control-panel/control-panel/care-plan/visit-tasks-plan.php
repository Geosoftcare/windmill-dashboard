                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h4 class="m-b-10">Task plan</h4>
                                </div>
                                <ul class="breadcrumb">
                                    <li style="font-size: 16px;" class="breadcrumb-item">
                                        Capture outcomes, tasks and risks related to <?php echo "" . $row['client_first_name'] . "" ?>'s tasks plan.
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            ...
                            <span style="font-size: 16px;">
                                Record <?php echo "" . $row['client_first_name'] . "" ?>'s level of independence for each tasks plan activity, and any support that is required.
                            </span>


                            <br><br>
                            <a href="./review-tasks-plan?<?php echo "uryyToeSS4=" . $row['uryyToeSS4'] . "";
                                                        }
                            ...
                            if (isset($_GET['uryyToeSS4'])) {
                                $uryyToeSS4 = $_GET['uryyToeSS4'];
                                $result = mysqli_query($conn, "SELECT * FROM tbl_visit_tasks_plan WHERE uryyToeSS4='$uryyToeSS4' ");
                                while ($row = mysqli_fetch_array($result)) { ?>
