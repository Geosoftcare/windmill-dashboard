...
if (isset($_POST['btnSubmitOutcomeassessment'])) {
    ...
    $txtColumn_2 = mysqli_real_escape_string($conn, $_REQUEST['txtNotCapable']);
    $txtColumn_3 = mysqli_real_escape_string($conn, $_REQUEST['txtUnabletoAssist']);
    $txtColumn_4 = mysqli_real_escape_string($conn, $_REQUEST['txtableToAssist']);
    $txtColumn_5 = mysqli_real_escape_string($conn, $_REQUEST['txtFullyCapable']);
    ...
    $txtclientTasks = "Null";
    $txtAssessmentType = "Assessment2";
    $txtClientId = mysqli_real_escape_string($conn, $_REQUEST['txtClientId']);


    $queryIns = mysqli_query($conn, "INSERT INTO tbl_outcome_of_assessment (my_description, not_capable, unable_to_assist, able_to_assist, fully_capable, submitedDate, assessorName, assessorEmail, help_tasks, assessment_type, uryyToeSS4) 
    VALUES('" . $txtColumn_1 . "', '" . $txtColumn_2 . "', '" . $txtColumn_3 . "', '" . $txtColumn_4 . "', '" . $txtColumn_5 . "', '" . $txtCurrentDate . "', '" . $txtAssessorName . "', '" . $txtAssessorEmail . "', '" . $txtclientTasks . "', '" . $txtAssessmentType . "', '" . $txtClientId . "') ");
    if ($queryIns) {
        header("Location: ./assessment-page-2?uryyToeSS4=$txtClientId");
                ...
                <div class="col-xl-12 col-md-12">
                    ...
                    if (isset($_GET['uryyToeSS4'])) {
                        ...
                        while ($trans = mysqli_fetch_array($result)) { ?>
                            ...
                            <form action="./assessment-page-2<?php echo "?uryyToeSS4=" . $trans['uryyToeSS4'] . "" ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class='row'>
                                    ...
                                    <div class='col-xl-1 col-2'>
                                        <div class="form-group">
                                            <br><br>
                                            <label for="Response">Not capable</label>
                                            <br>
                                            <input type="checkbox" name="txtNotCapable" value="X" />
                                        </div>
                                    </div>
                                    <div class='col-xl-1 col-2'>
                                        <div class="form-group">
                                            <br><br>
                                            <label for="Response">Unable to assist</label>
                                            <br>
                                            <input type="checkbox" name="txtUnabletoAssist" value="X" />
                                        </div>
                                    </div>
                                    <div class='col-xl-1 col-2'>
                                        <div class="form-group">
                                            <br><br>
                                            <label for="Response">Able to assist</label>
                                            <br>
                                            <input type="checkbox" name="txtableToAssist" value="X" />
                                        </div>
                                    </div>
                                    <div class='col-xl-1 col-2'>
                                        <div class="form-group">
                                            <br><br>
                                            <label for="Response">Fully capable</label>
                                            <br>
                                            <input type="checkbox" name="txtFullyCapable" value="X" />
                                        </div>
                                    </div>
                                </div>
