        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form action="./edit-next-of-kin-263554-588577-9000494-0598i7222?uryyToeSS4=<?php echo $uryyToeSS4; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <?php
                        $sel_team_data_result = mysqli_query($conn, "SELECT * FROM tbl_client_nok WHERE uryyToeSS4='$uryyToeSS4' AND col_company_Id = '" . $_SESSION['usr_compId'] . "' ORDER BY userId DESC LIMIT 1");
