                        ...
                        <div style="margin-top: 15px;" class="row">
                            <div class="col-md-6 col-xl-6 col-sm-6 col-lg-6">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a class="btn btn-info text-decoration-none" href="./view-marchart?uryyToeSS4=<?php echo $myuryyToeSS4; ?>" style="text-decoration:none;">
                                        <i class="feather mr-2 icon-list"></i>MarChart list
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-striped table-hover text-left mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <?php foreach ($dates as $formatted_date) {
                                        ...
                                        <tbody>
                                            <?php foreach ($medications as $med_name => $med_dates) { ?>
                                                <tr>
                                                    <td class="text-left"><?php echo $med_name; ?></td>
                                                    <?php foreach ($dates as $med_date => $formatted_date) { ?>
                                                        <td class="text-center"><?php echo isset($med_dates[$med_date]) ? '<span title="Taken" class="green-circle"></span>' : '<span title="Missed" class="red-circle"></span>'; ?></td>
                                                    <?php } ?>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
