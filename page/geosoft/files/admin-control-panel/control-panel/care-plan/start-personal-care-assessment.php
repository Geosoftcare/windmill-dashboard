...
$varClientName = $row['client_first_name'] . ' ' . $row['client_last_name'];
$_SESSION['txtUserId'] = $uryyToeSS4;
?>
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h4 class="m-b-10"><?php echo $varClientName; ?>'s assessment</h4>
                        </div>
                        <ul class="breadcrumb">
                            <li style="font-size: 16px;" class="breadcrumb-item">
                                Record <?php echo $varClientName; ?>'s level of independence for each and any support that is required
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container my-5">
            <div class="row text-decoration-none mt-3 rounded">
                <div class="col-md-5 col-sm-5 col-xl-5 col-lg-5">
                    <form action="./processing-personal-care-assessment" method="POST" enctype="multipart/form-data" autocomplete="off">
