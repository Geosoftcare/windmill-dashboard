    ...
    <div class="pcoded-content">
        <div class="row">
            <div class="col-md-3 col-xl-3 col-sm-3">
                ...
                ?>
                <h4>
                    Scheduled visits <br><small style="font-weight: 600;"><?php echo $clientName . " (" . $rowcount . ")"; ?></small></h4>
            </div>
            ...
            <div class="col-md-12">
                <div id="yourdiv">
                    <div class="row">
                        ...
                        WHERE (c.first_carer_Id = '$varRecentCarer' AND c.Clientshift_Date = '$visitCookieDate' AND c.call_status ='Scheduled' AND a.col_client_Id IS NULL AND c.uryyToeSS4 = '$uryyToeSS4' 
