    ...
    <div class="pcoded-content">
        <div class="row">
            ...
            <div class="col-xl-8">
                <h5>Required carer
                    <br>
                    <small>Number of required carer(s) for all care call.</small>
                </h5>
                <hr>
                <br>

                <form method="POST" action="./processing-carers-required-all-care-call" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div style="background-color:rgba(189, 195, 199,.2); font-size:16px; font-weight:600; border-left:8px solid rgba(192, 57, 43,1.0); padding:22px; border-radius:5px;">
                                            Kindly us the select box below to chose the numbers of carers required for all care call.
                                        </div>
                                        <br>
