...
if (isset($_POST['btnshareAccessCode'])) {
    ...
    $txtCompanySpecialId = mysqli_real_escape_string($conn, $_REQUEST['txtCompanySpecialId']);
    $txtCompanySpecialId = strip_tags($txtCompanySpecialId);
    $txtCompanySpecialId = htmlspecialchars($txtCompanySpecialId);
...
";
    ...
    header("Location: ./share-family-access?uryyToeSS4=$txtCompanySpecialId");
} else {
}
