                            ...
                            <h5 class="m-b-10">Edit care call <br>
                                ...
                                if (isset($_GET['uryyToeSS4'])) {
                                    ...
                                    while ($rowClientName = mysqli_fetch_array($getClientName)) {
                                        ...
                                        echo "
                                <small>Re-assign $ClientNameHere Lunch call</small>
                                ";
                                    }
                                }
                                ?>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="menu1" class="container tab-pane fade"><br>
                                                <h5>Cancel Call</h5>
                                                <p>
                                                <form method="POST" action="./processing-cancel-lunch-call" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
