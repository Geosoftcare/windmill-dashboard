    ...
    <div class="pcoded-content">
        <div class="row">
            <div class="col-md-3 col-xl-3 col-sm-3">
                ...
                $result = "SELECT * FROM tbl_schedule_calls WHERE (uryyToeSS4='$uryyToeSS4' AND call_status ='Completed' 
                AND col_company_Id = '" . $_SESSION['usr_compId'] . "') ";
                $result = mysqli_query($conn, $result);
                $rowcount = mysqli_num_rows($result);
                ?>
                <h4>Completed visits <br><small style="font-weight: 600;"><?php echo $clientName . " (" . $rowcount . ")"; ?>)
                    </small></h4>
            </div>
