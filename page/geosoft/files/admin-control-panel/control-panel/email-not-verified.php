            ...
            <div class="row align-items-center text-center">
                <div class="col-md-12">
                    ...
                    <div class="">
                        ...
                        Thank you for registering with us. A verification link has been sent to your email. <br> Kindly click the link or copy, paste and run the link in your browser to verify your email.
                        <br><br>

                        <button id="popvery" onclick="showDiv()" type="button" class="btn  btn-primary btn-lg">Resend verification link</button>
                    </div>
                    <br /><br>
                </div>
            </div>
