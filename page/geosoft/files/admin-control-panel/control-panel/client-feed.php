...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        ...
        ?> <br>
        <h4>Client feeds <br><small style="font-weight: 600;"><?php echo $clientName; ?>
                (<?php
            ...
            <div class="col-lg-12">
                ...
                <div id="yourdiv">
                    <div class="row">
                        ...
                        <?php
                        $date_query = mysqli_query($conn, "SELECT DISTINCT(DATE(Clientshift_Date)) AS ClientshifTd FROM tbl_schedule_calls order by Clientshift_Date asc");
                        while ($row = mysqli_fetch_array($date_query)) {
                            echo "
                            <hr>
                            <h5>
                                <strong>
                                    <i class='feather mr-2 icon-calendar'></i>" . date('d M, Y', strtotime("" . $row['ClientshifTd'] . "")) . ",
                                    " . date('l', strtotime("" . $row['ClientshifTd'] . "")) . "
                                </strong>
                            </h5>";

                            $result = mysqli_query($conn, "SELECT * FROM tbl_schedule_calls WHERE (uryyToeSS4='$uryyToeSS4' AND call_status = 'Completed' AND col_company_Id = '" . $_SESSION['usr_compId'] . "') ORDER BY Clientshift_Date DESC ");
