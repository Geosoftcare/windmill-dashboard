...
?>
        ...
        <a style="text-decoration: none;" href="./care-plan/view-marchart?<?php echo "uryyToeSS4=" . $uryyToeSS4 . ""; ?>">
            <button type="button" class="btn btn-outline-primary"><i class="feather mr-2 icon-eye"></i>View MAR chart</button>
        </a>
        <a style="text-decoration: none;" href="./setup-visits?<?php echo "uryyToeSS4=" . $uryyToeSS4 . "";
                                                            }
                                                        } ?>">
                    ...
                    <table class="table table-striped table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['uryyToeSS4'])) {
                                ...
                                FROM tbl_clients_medication_records WHERE (uryyToeSS4='$uryyToeSS4' AND col_company_Id = '" . $_SESSION['usr_compId'] . "') ");
                                while ($row = mysqli_fetch_array($result)) {
                                    echo "
