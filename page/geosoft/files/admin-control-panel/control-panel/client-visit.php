    ...
    <div class="pcoded-content">
        <div class="row">
            <div class="col-md-3 col-xl-3 col-sm-3">
                ...
                AND call_status = 'Scheduled' AND col_company_Id = '" . $_SESSION['usr_compId'] . "') 
            ...
            <div class="col-md-12">
                <div id="yourdiv">
                    <div class="row">
                        ...
                        AND uryyToeSS4='$uryyToeSS4' AND col_company_Id = '" . $_SESSION['usr_compId'] . "') 
                        ...
                        $query = "
                            ...
                            WHERE (c.first_carer_Id = '$varRecentCarer' AND Clientshift_Date = '$visitCookieDate' AND a.col_client_Id IS NULL AND c.uryyToeSS4 = '$uryyToeSS4' AND c.col_company_Id = '" . $_SESSION['usr_compId'] . "') ORDER BY c.dateTime_in ASC ";
