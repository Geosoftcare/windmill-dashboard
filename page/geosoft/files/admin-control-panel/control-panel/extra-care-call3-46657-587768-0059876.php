    ...
    <div class="pcoded-content">
        <div class="row">
            ...
            ?>
                    ...
                    <div class="col-xl-8">
                        <h5>Update extra tea call <br> <small><?php echo "" . $get_extra_care_call_row['client_first_name'] . " " . $get_extra_care_call_row['client_last_name'] . ""; ?> Extra tea care call</small></h5>
                        <hr>
