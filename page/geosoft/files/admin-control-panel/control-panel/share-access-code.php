        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xl-7">
                ...
                if (isset($_GET['col_company_Id'])) {
                    ...
                    WHERE col_company_Id='$col_company_Id' ORDER BY userId DESC LIMIT 1");
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="font-size: 16px;">
                                <form action="./processing-company-share-code" method="POST" enctype="multipart/form-data" name="deactivate-admin" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="txtShareUrl" value="https://geosoftcare.co.uk/page/geosoft/files/admin-control-panel/control-panel/share-access-signup?col_company_Id=<?php echo "" . $row['col_company_Id'] . ""; ?>">
                                    </div>
                                    <div class="form-group">
