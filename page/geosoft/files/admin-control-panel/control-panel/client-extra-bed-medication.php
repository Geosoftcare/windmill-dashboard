                                    ...
                                    <div class="client-form-body" style="width:100%; height:auto; padding:22px;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <form method="POST" action="./client-extra-bed-medication?uryyToeSS4=<?php echo "" . $row['uryyToeSS4'] . ""; ?>" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
                                                            ...
                                                            <div class="tab-content" id="myTabContent">
                                                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                                    <div class="daysAlignment" style="width: 100%; height:auto; padding:12px 0px 0px 20px;">
                                                                        <div class="row">
                                                                            <div class="col">
                                                                                <input type="hidden" value="Extra bed call" name="txtCareCall">
                                                                                <span style="font-size:16px;">&nbsp;Extra bed care call</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <button style='height:50px;' type="submit" name="btnSubmitExtraBedMeds" class="btn  btn-primary">Upload medication</button>
