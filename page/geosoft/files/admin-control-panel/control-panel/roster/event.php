...
<body>
    ...
    <script>
      ...
      locale: mobiscroll.localeNl,                    // Specify language like: locale: mobiscroll.localePl or omit setting to use default
    ...
    calendar = mobiscroll.eventcalendar('#demo-work-order-scheduling', {
      ...
      data: [                                         // More info about data: https://mobiscroll.com/docs/javascript/eventcalendar/api#opt-data
        {
          start: '2024-08-01T06:00',
          end: '2024-08-01T14:00',
          title: 'Farmhouse TPH',
        ...
        {
          start: '2024-08-02T08:00',
          end: '2024-08-02T18:00',
        ...
        {
          start: '2024-08-03T12:00',
          end: '2024-08-03T20:00',
        ...
        {
          start: '2024-08-04T11:00',
          end: '2024-08-04T19:00',
        ...
        {
          start: '2024-08-05T10:00',
          end: '2024-08-05T18:00',
        ...
        {
          start: '2024-08-05T08:00',
          end: '2024-08-05T16:00',
        ...
        {
          start: '2024-08-07T07:00',
          end: '2024-08-07T15:00',
