        ...
        <div style="display:none;">
            <div id="demo-work-order-popup">
                <div class="mbsc-form-group">
                    ...
                    <label>
                        Status
                        <button mbsc-textarea id="work-order-status">sdfas</button>
                    </label>
                    <label>
                        Planned time in
...
<div style="position:absolute; top:2px; width:78%; font-size:18px; left:200px; z-index:1000;">
    <div class="row">
        <div class="col-md-2 col-2">
            <div style="width:100%; height:35px; border:1px solid rgba(45, 52, 54,.4); margin-top:5px; border-radius:6px; text-align:center;">
                <form action="./carer-view" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <?php $varViewCurrentDate = $_SESSION['currentDate'] = date('Y-m-d'); ?>
                    <select onchange="this.form.submit()" name="txtCarerView" id="select_page" style="width:100%; height:auto; font-size:16px; font-weight:600; border:1px solid #fff;" class="form-control">
