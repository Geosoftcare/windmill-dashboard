...
<body>
    ...
    <div style="position:absolute; width:78%; top:2px; font-size:18px; left:200px; z-index:1000;" class="container">
        <div class="row">
                    ...
                    <div class="multipleSelection">
                        ...
                        <div id="checkBoxes">
                            ...
                            <label for='Client view'>
                                <input value='" . $cityRow["col_area_city"] . "' required name='checkCityView' type='checkbox' id='' />
            ...
            <div style="padding: 0px;" class="col-md-2">
                <a href="../schedule-roster" style="text-decoration: none;">
        ...
        calendar = mobiscroll.eventcalendar('#demo-work-order-scheduling', {
            ...
            data: [
...

                {
                    ...
                    resource: ['" . $att_cor_rw["client_resource"] . "'],
...
";
            ...
            renderDay: function(args) {
                ...
                return (
                    ...
                    '</div>' +
                    '<div class="md-work-order-date-title">New week rota' +
                    getCostString(costs) +
                    '</div>'
                );
            },
