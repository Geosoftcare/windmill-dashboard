...
if (isset($_POST['btnSubmitExtraCall'])) {
    ...
    $txtETMorningStarts = mysqli_real_escape_string($conn, $_REQUEST['txtMorningStarts']);
    $txtETMorningEnd = mysqli_real_escape_string($conn, $_REQUEST['txtMorningEnd']);
