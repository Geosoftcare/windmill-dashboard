    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h4 class="m-b-10">Travel rates</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-md-12">
                <a href="./new-travel-rate" style="text-decoration: none;">
                    <button class="btn btn-outline-secondary">New travel rate</button>
                </a>
                <br><br>
