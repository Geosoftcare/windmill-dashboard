    ...
    <div class="pcoded-content">
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-md-12">
                ...
                <div class="col-md-12">
                    <form action="./planned-visit-result" method="post" enctype="multipart/form-data" autocomplete="off" name="formData">
                        <div class="row">
                            <div class="col-md-4">
                                        ...
                                        if (isset($_POST['btnFetchData'])) {
                                            ...
                                            while ($getholdof_rows = mysqli_fetch_array($SelectQuery)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span style='border-radius:15px; padding:2px 10px 3px 10px; background-color:rgba(46, 204, 113,.7); font-size:16px; color:white;'>" . $getholdof_rows['planned_timeIn'] . " - " . $getholdof_rows['planned_timeOut'] . "</span></td>
