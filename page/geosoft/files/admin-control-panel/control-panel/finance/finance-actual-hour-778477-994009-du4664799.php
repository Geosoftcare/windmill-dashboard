                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h4 class="m-b-10">Actual visits
                                <br>
                                <small>
                                    Review, actual visits before they're added to timesheets and/or invoices
                                </small>
                            </h4>
                        </div>
                    </div>
            ...
            <div style="padding: 0;" class="col-md-3">
                <div class="form-cover" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; padding:25px 15px 25px 15px; border-radius:12px;">
                    <form action="./set-dashboard-cookie" method="post" enctype="multipart/form-data" autocomplete="off" name="formData">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="submit" name="btnFetchActualVisitData" class="btn btn-small btn-info" value="Fetch data" />
                            </div>
                        </div>
                    </form>
                </div>
