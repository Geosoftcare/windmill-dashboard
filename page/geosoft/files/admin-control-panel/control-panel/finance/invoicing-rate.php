...
$sql_holiday_rate = mysqli_query($conn, "SELECT * FROM `tbl_invoice_rate` WHERE (col_special_Id = '$varHolidayId' AND `col_company_Id` = '" . $_SESSION['usr_compId'] . "') ");
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover mb-0">
                                ...
                                <tbody>
                                    <?php
                                    $SelectQuery = mysqli_query($conn, "SELECT * FROM tbl_invoice_rate WHERE (col_special_Id = '$varHolidayId' AND col_company_Id = '" . $_SESSION['usr_compId'] . "') ");
