        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-md-12">
                ...
                if (isset($_GET['col_special_Id'])) {
                    ...
                    $SelectQuery = mysqli_query($conn, "SELECT * FROM tbl_pay_rate WHERE col_special_Id = '$col_special_Id' AND col_company_Id = '" . $_SESSION['usr_compId'] . "' ");
                    while ($getholdof_rows = mysqli_fetch_array($SelectQuery)) {
                ?>
                        <div class="col-md-12">
                            <form action="./processing-edit-new-pay-rate" method="post" enctype="multipart/form-data" autocomplete="off" name="formData">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input style="float: right;" type="submit" name="btnUpdatePayRateData" class="btn btn-small btn-info" value="Update data" />
                                </div>
                            </form>
                        </div>
                        <br>
