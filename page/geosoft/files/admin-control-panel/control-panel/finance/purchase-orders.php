    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h4 class="m-b-10">Purchase orders</h4>
                            <span>Show cancelled purchase orders.</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-md-12">
                <a href="./new-purchase-order" style="text-decoration: none;">
                    <button class="btn btn-outline-secondary">New purchase orders</button>
                </a>
                <br><br>
