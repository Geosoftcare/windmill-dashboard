                                    ...
                                    <div class="client-form-body" style="width:100%; height:auto; padding:22px;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <form method="POST" action="./client-extra-morning-tasks?uryyToeSS4=<?php echo "" . $row['uryyToeSS4'] . ""; ?>" enctype="multipart/form-data" name="addClient-form" autocomplete="off">
                                                    ...
                                                    <button style='height:50px;' type="submit" name="btnExtraMorningTask" class="btn btn-primary">Upload task</button>
