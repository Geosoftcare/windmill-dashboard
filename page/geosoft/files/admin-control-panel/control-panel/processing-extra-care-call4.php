...
if (isset($_POST['btnSubmitExtraCall'])) {
    ...
    $txtExtraBedCareCall = "EB bed call";
    ...
    $txtEBBedStarts = mysqli_real_escape_string($conn, $_REQUEST['txtBedStarts']);
    $txtEBBedEnd = mysqli_real_escape_string($conn, $_REQUEST['txtBedEnd']);
    ...
    if ($clickDisplayDaily) {
        ...
        VALUES('" . $txtClientFullName . "', '" . $txtClientArea . "', '" . $clientId . "', '" . $txtExtraBedCareCall . "', '" . $txtDateTimeIn . "', '" . $txtDateTimeOut . "', '" . $txtMonday . "', '" . $txtTuesday . "', '" . $txtWednesday . "', '" . $txtThursday . "', '" . $txtFriday . "', '" . $txtSaturday . "', '" . $txtSunday . "', '" . $var_client_funding_name . "', '" . $var_client_funding_rate . "', '" . $txtRequiredCarers . "', '" . $txtBedStarts . "', '" . $txtBedEnd . "', '" . $txtBedStarts . "', 'Daily', 'True', '" . $_SESSION['usr_compId'] . "') ");
