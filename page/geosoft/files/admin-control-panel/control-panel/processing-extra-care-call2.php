...
if (isset($_POST['btnSubmitExtraCall'])) {
    ...
    $txtExtraLunchCareCall = "EL lunch call";
    ...
    $txtELLunchStarts = mysqli_real_escape_string($conn, $_REQUEST['txtLunchStarts']);
    $txtELLunchEnd = mysqli_real_escape_string($conn, $_REQUEST['txtLunchEnd']);
    ...
    if ($clickDisplayDaily) {
        ...
        VALUES('" . $txtClientFullName . "', '" . $txtClientArea . "', '" . $clientId . "', '" . $txtExtraLunchCareCall . "', '" . $txtDateTimeIn . "', '" . $txtDateTimeOut . "', '" . $txtMonday . "', '" . $txtTuesday . "', '" . $txtWednesday . "', '" . $txtThursday . "', '" . $txtFriday . "', '" . $txtSaturday . "', '" . $txtSunday . "', '" . $var_client_funding_name . "', '" . $var_client_funding_rate . "', '" . $txtRequiredCarers . "', '" . $txtLunchStarts . "', '" . $txtLunchEnd . "', '" . $txtLunchStarts . "', 'Daily', 'True', '" . $_SESSION['usr_compId'] . "') ");
