...
if (isset($_GET['uryyToeSS4'])) {
    ...
    $result_name = mysqli_query($conn, "SELECT * FROM tbl_general_client_form WHERE uryyToeSS4='$uryyToeSS4' ");
    $row = mysqli_fetch_array($result_name);
    $client_name = $row['client_first_name'] . ' ' . $row['client_last_name'];
    $_SESSION['care_calls'] = 'Lunch';
    $_SESSION['client_fullName'] = $client_name;
} ?>
...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        <div class="row">
            ...
            <div class="col-xl-8">
                <h5>Update care call<br><small><?php print $client_name; ?> Lunch visit time</small></h5>
                <hr>
                ...
                <div style="width: 100%; height:auto; padding:2px; text-align:right;">
                    <a href="./visit-details?uryyToeSS4=<?php print $uryyToeSS4; ?>" style="text-decoration: none;">
                        <button class="btn btn-info btn-small">Details</button>
                    </a>
                    <a href="./carers-required-morning-care-call?uryyToeSS4=<?php print $uryyToeSS4; ?>" style="text-decoration: none;">
                        <button type="button" class="btn btn-outline-secondary btn-small">Carers</button>
                    </a>
