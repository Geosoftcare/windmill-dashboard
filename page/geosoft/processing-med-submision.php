...
if (isset($_POST['btnSubmitMedNote'])) {
    ...
    $myCheck = "SELECT * FROM tbl_finished_meds WHERE (task_SpecialId = '$txtTaskId' AND med_date = '$today' AND care_calls = '$txtCurerCall' AND col_company_Id = '" . $_SESSION['usr_compId'] . "') ";
    ...
    if ($countRes) {
        if ($mycheckNObox) {
            if ($txtTaskNoteNoOp == '') {
                ...
                `care_calls` = '$txtCurerCall', `care_call_days` = '$CurrentDayInName', `col_task_status` = '$txtTaskStatus', `col_care_call_Id` = '$txtClientCareCallId' WHERE (`task_SpecialId` = '$txtTaskId' AND `care_calls` = '$txtCurerCall' AND `med_date` = '$today' AND `col_company_Id` = '$txtClientCompId') ");
        ...
        if ($mycheckNObox) {
            if ($txtTaskNoteNoOp == '') {
                ...
                $queryIns = mysqli_query($conn, "INSERT INTO tbl_finished_meds (task_name, med_date, task_timeIn, task_note, task_SpecialId, uryyToeSS4, team_1email, category, col_dosage, col_carername, col_outcome, care_calls, care_call_days, col_task_status, col_care_call_Id, col_company_Id) 
                    VALUES('" . $txtTaskName . "', '" . $today . "', '" . $txtTaskTimeIn . "', '" . $txtTaskNoteNoOp . "', '" . $txtTaskId . "', '" . $txtClientId . "', '" . $txtCarerEmail . "', '" . $txtTask . "', '" . $txtDosage . "', '" . $txtCarerName . "', '" . $mycheckNObox . "', '" . $txtCurerCall . "', '" . $CurrentDayInName . "', '" . $txtTaskStatus . "', '" . $txtClientCareCallId . "', '" . $txtClientCompId . "' ) ");
                if ($queryIns) {
                    $myCheck_order = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE (uryyToeSS4 = '$txtClientId' AND (care_call1='$clientCurCallCalls' OR care_call1='Breakfast' OR care_call2='$clientCurCallCalls' OR care_call3='$clientCurCallCalls' OR care_call4='$clientCurCallCalls' OR extra_call1='$clientCurCallCalls' OR extra_call2='$clientCurCallCalls' OR extra_call3='$clientCurCallCalls' OR extra_call4='$clientCurCallCalls') 
                    AND col_fifo != '' AND col_company_Id = '" . $_SESSION['usr_compId'] . "') ORDER BY med_Id DESC LIMIT 1");
                    ...
                    if ($countRes_order != 0) {
                        ...
                        $sqlUpdate2 = mysqli_query($conn, "UPDATE `tbl_clients_medication_records` SET `med_colours` = '$med_colours', `visibility` = '$today', `col_fifo` = '$txtCalcOrderNumber' WHERE col_taskId = '$txtTaskId' AND col_company_Id = '" . $_SESSION['usr_compId'] . "' ");
                        if ($sqlUpdate2) {
                            ...
                            if ($get_periodtwo == 'Daily') {
                                ...
                                if ($myCheck_periodtwo == $myCheck_period) {
                                    ...
                                    $sql_update_periodWeeks = mysqli_query($conn, "UPDATE `tbl_clients_medication_records` SET `col_occurence` = '$final_Weeks' WHERE (`col_taskId` = '$txtTaskId' AND col_occurence = '$get_occurence' AND col_company_Id = '" . $_SESSION['usr_compId'] . "') ");
                        ...
                        $txtCalcOrderNumber = 1;
                        $sqlUpdate_order = mysqli_query($conn, "UPDATE `tbl_clients_medication_records` SET `med_colours` = '$med_colours', `visibility` = '$today', `col_fifo` = '$txtCalcOrderNumber' WHERE col_taskId = '$txtTaskId' AND col_company_Id = '" . $_SESSION['usr_compId'] . "' ");
                        if ($sqlUpdate_order) {
                            $myCheck_periodtwo = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE (med_Id = '$txtTask_IdNo' AND col_company_Id = '" . $_SESSION['usr_compId'] . "') ");
                            $row_periodtwo = mysqli_fetch_array($myCheck_periodtwo);
                            $get_occurence = $row_periodtwo['col_occurence'];
            ...
            $queryIns2 = mysqli_query($conn, "INSERT INTO tbl_finished_meds (task_name, med_date, task_timeIn, task_note, task_SpecialId, uryyToeSS4, team_1email, category, col_dosage, col_carername, col_outcome, care_calls, care_call_days, col_task_status, col_care_call_Id, col_company_Id) 
                    VALUES('" . $txtTaskName . "', '" . $today . "', '" . $txtTaskTimeIn . "', '" . $txtTaskNoteYesOp . "', '" . $txtTaskId . "', '" . $txtClientId . "', '" . $txtCarerEmail . "', '" . $txtTask . "', '" . $txtDosage . "', '" . $txtCarerName . "', '" . $mycheckYesbox . "', '" . $txtCurerCall . "', '" . $CurrentDayInName . "', '" . $txtTaskStatus . "', '" . $txtClientCareCallId . "', '" . $txtClientCompId . "' ) ");
            if ($queryIns2) {
                $myCheck_order = mysqli_query($conn, "SELECT * FROM tbl_clients_medication_records WHERE (uryyToeSS4 = '$txtClientId' AND (care_call1='$clientCurCallCalls' OR care_call1='Breakfast' OR care_call2='$clientCurCallCalls' OR care_call3='$clientCurCallCalls' OR care_call4='$clientCurCallCalls' OR extra_call1='$clientCurCallCalls' OR extra_call2='$clientCurCallCalls' OR extra_call3='$clientCurCallCalls' OR extra_call4='$clientCurCallCalls') 
                AND col_fifo != '' AND col_company_Id = '" . $_SESSION['usr_compId'] . "') ORDER BY med_Id DESC LIMIT 1");
                $row_order = mysqli_fetch_array($myCheck_order);
